...
var sidebar_menu_handler = function(ev) {
...
var menu_toggle_handler = function() {
...
function init_sidebar() {
  ...
  $SIDEBAR_MENU.find('a').bind('click', sidebar_menu_handler);

  $MENU_TOGGLE.bind('click', null, menu_toggle_handler);
